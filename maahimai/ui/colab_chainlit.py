...
from maahimai.ui.colab import ui_run_maahimai, load_tools_from_tools_py
from maahimai.ui.callbacks import callback, trigger_callback
...
async def main(message: cl.Message):
    ...
    try:
        ...
        await cl.Message(
            content="Using Running MaahimAI Agents...",
            author="System"
        ).send()

        # Run MaahimAI with the message content as the topic
